...
export let disclosureOfPersonalInformationModule:any = [
    ...
    },
    {
        ...
        extraInfo: {
            ...
            content: "For example, an obvious reason for collection personal information could be then someone buys a ticket to a show or comes into our office to seek services"
        }
    },
    {
        id: 17,
